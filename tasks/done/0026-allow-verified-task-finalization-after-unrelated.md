...
Installed the verified release locally and restarted the existing scheduler; confirmed its executable matches the tested release. The affected project's paused setting was preserved.
