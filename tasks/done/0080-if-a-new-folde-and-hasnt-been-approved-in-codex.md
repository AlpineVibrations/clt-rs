...
│ignal Codex process group <pid> with 15: Operation not permitted (os error 1)                          not sure how to handle but we might need it to make a new task to get permission by the user. can we ask for it. what needs to happen. also getting error trying to unregister this test project. Error: Failed to unregister project /path/to/project
