...
Acceptance: Oversized coordinators are decomposed and deterministic dependencies are injectable while all scheduling and recovery behavior remains unchanged.
