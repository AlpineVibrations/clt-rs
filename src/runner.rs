...
- Always skip tasks marked `[STOPPED]` by clt or carrying a terminal `clt:stopped` marker, including during blocked-task recovery. Only the user may start them again.
