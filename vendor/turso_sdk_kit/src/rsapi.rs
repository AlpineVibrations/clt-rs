...
mod tests {
    ...
    mod encryption_tests {
        ...
        fn create_encryption_opts() -> crate::turso_sdk_kit::rsapi::EncryptionOpts {
            crate::turso_sdk_kit::rsapi::EncryptionOpts {
        ...
        fn test_encryption() {
            ...
            // 4. Verify opening with wrong key fails
            {
                let db = TursoDatabase::new(TursoDatabaseConfig {
                    ...
                    experimental_features: Some("encryption".to_string()),
                    async_io: false,
                    encryption: Some(crate::turso_sdk_kit::rsapi::EncryptionOpts {
                        cipher: TEST_CIPHER.to_string(),
