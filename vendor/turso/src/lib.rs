...
#[cfg(all(clt_turso_feature = "mimalloc", not(target_family = "wasm"), not(miri)))]
#[global_allocator]
...
// Re-exports rows
pub use crate::turso::rows::{Row, Rows};
...
impl From<crate::turso_sdk_kit::rsapi::TursoError> for Error {
    fn from(value: crate::turso_sdk_kit::rsapi::TursoError) -> Self {
        match value {
            crate::turso_sdk_kit::rsapi::TursoError::Busy(err) => Error::Busy(err),
            crate::turso_sdk_kit::rsapi::TursoError::BusySnapshot(err) => Error::BusySnapshot(err),
            crate::turso_sdk_kit::rsapi::TursoError::Interrupt(err) => Error::Interrupt(err),
            crate::turso_sdk_kit::rsapi::TursoError::Error(err) => Error::Error(err),
            crate::turso_sdk_kit::rsapi::TursoError::Misuse(err) => Error::Misuse(err),
            crate::turso_sdk_kit::rsapi::TursoError::Constraint(err) => Error::Constraint(err),
            crate::turso_sdk_kit::rsapi::TursoError::Readonly(err) => Error::Readonly(err),
            crate::turso_sdk_kit::rsapi::TursoError::DatabaseFull(err) => Error::DatabaseFull(err),
            crate::turso_sdk_kit::rsapi::TursoError::NotAdb(err) => Error::NotAdb(err),
            crate::turso_sdk_kit::rsapi::TursoError::Corrupt(err) => Error::Corrupt(err),
            crate::turso_sdk_kit::rsapi::TursoError::IoError(kind, op) => Error::IoError(kind, op),
        }
    }
}
...
pub type EncryptionOpts = crate::turso_sdk_kit::rsapi::EncryptionOpts;
...
pub struct Builder {
    ...
    vfs: Option<String>,
    encryption_opts: Option<crate::turso_sdk_kit::rsapi::EncryptionOpts>,
...
impl Builder {
    ...
    pub fn with_encryption(mut self, opts: crate::turso_sdk_kit::rsapi::EncryptionOpts) -> Self {
...
#[derive(Clone)]
pub struct Database {
    inner: Arc<crate::turso_sdk_kit::rsapi::TursoDatabase>,
}
...
pub struct Statement {
    conn: Connection,
    inner: Arc<Mutex<Box<crate::turso_sdk_kit::rsapi::TursoStatement>>>,
}
...
impl Statement {
    fn step(
        ...
        match stmt.step(Some(cx.waker()))? {
            crate::turso_sdk_kit::rsapi::TursoStatusCode::Row => {
            ...
            crate::turso_sdk_kit::rsapi::TursoStatusCode::Done => Poll::Ready(Ok(None)),
            crate::turso_sdk_kit::rsapi::TursoStatusCode::Io => {
                stmt.run_io()?;
