use crate::turso::assert_send_sync;
use crate::turso::transaction::DropBehavior;
use crate::turso::transaction::TransactionBehavior;
use crate::turso::Error;
use crate::turso::IntoParams;
use crate::turso::Row;
use crate::turso::Rows;
use crate::turso::Statement;
use std::fmt::Debug;
...
pub struct Connection {
    ...
    inner: Option<Arc<crate::turso_sdk_kit::rsapi::TursoConnection>>,
...
impl Connection {
    pub(crate) fn create(
        conn: Arc<crate::turso_sdk_kit::rsapi::TursoConnection>,
    ...
    fn get_inner_connection(&self) -> Result<Arc<crate::turso_sdk_kit::rsapi::TursoConnection>> {
        match &self.inner {
    ...
    where
        F: FnMut(&Row) -> std::result::Result<(), crate::turso_sdk_kit::rsapi::TursoError>,
    {
