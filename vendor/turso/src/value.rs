...
impl From<crate::turso_sdk_kit::rsapi::Value> for Value {
...
impl From<Value> for crate::turso_sdk_kit::rsapi::Value {
    fn from(val: Value) -> Self {
        match val {
            Value::Null => crate::turso_sdk_kit::rsapi::Value::Null,
            Value::Integer(n) => crate::turso_sdk_kit::rsapi::Value::from_i64(n),
            Value::Real(n) => crate::turso_sdk_kit::rsapi::Value::from_f64(n),
            Value::Text(t) => crate::turso_sdk_kit::rsapi::Value::from_text(t),
            Value::Blob(items) => crate::turso_sdk_kit::rsapi::Value::from_blob(items),
        }
    }
}
